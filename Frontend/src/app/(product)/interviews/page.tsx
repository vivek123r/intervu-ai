...
import { useSyncCalendarMutation } from "@/services/api/calendar.api";
    ...
    <motion.div {...pageTransition} className={styles.productPage}>
      <header className={styles.pageHeading}>
        ...
        <div className={styles.pageActions}>
          <ActionButton variant="ghost" onClick={() => void handleSync()}><CalendarSync size={16} /> {syncing ? "Syncing…" : synced ? "Synced" : "Sync calendar"}</ActionButton>
      ...
      <section className={styles.calendarWorkspace}>
        <Surface className={styles.calendarSurface}>
          ...
          {view === "month" && <MonthCalendar interviews={sorted} onSelect={setSelectedId} />}
          {view === "week" && <WeekCalendar interviews={sorted} onSelect={setSelectedId} />}
        ...
        {selectedInterview && <Surface gold className={styles.selectedInterviewPanel}><InterviewDetail interview={selectedInterview} /></Surface>}
      </section>
